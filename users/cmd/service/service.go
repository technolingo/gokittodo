...
import (
	...
	"flag"
	"fmt"
	circuitbreaker "github.com/go-kit/kit/circuitbreaker"
	endpoint1 "github.com/go-kit/kit/endpoint"
	log "github.com/go-kit/kit/log"
	prometheus "github.com/go-kit/kit/metrics/prometheus"
	ratelimit "github.com/go-kit/kit/ratelimit"
	...
	grpc "github.com/technolingo/gokittodo/users/pkg/grpc"
...
var consulAddr = fs.String("consul-addr", "127.0.0.1:8500", "consul address")
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("users", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
...
func getEndpointMiddleware(logger log.Logger) (mw map[string][]endpoint1.Middleware) {
	...
	addEndpointMiddlewareToAllMethods(mw, circuitbreaker.Gobreaker(gobreaker.NewCircuitBreaker(rate.Every(time.Second), 1)))
	return
}
