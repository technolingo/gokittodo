...
func (c *usersClient) Retrieve(ctx context.Context, in *RetrieveRequest, opts ...grpc.CallOption) (*RetrieveReply, error) {
	out := new(RetrieveReply)
	err := c.cc.Invoke(ctx, "/pb.Users/Retrieve", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUsersServer) Retrieve(context.Context, *RetrieveRequest) (*RetrieveReply, error) {
